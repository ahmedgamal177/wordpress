...
function Villas() {
	...
	$labels = array(
		'name' => _x('Villas', 'plural'),
		'singular_name' => _x('Villas', 'singular'),
		'menu_name' => _x('Villas', 'admin menu'),
		'name_admin_bar' => _x('Villas', 'admin bar'),
		'add_new' => _x('Add Villa', 'add new'),
		'add_new_item' => __('Add New Villas'),
		'new_item' => __('New Villas'),
		'edit_item' => __('Edit Villas'),
...
function Properties() {
	...
	$labels = array(
		...
		'add_new' => _x('Add Property', 'add new'),
